...
public class TrendBookAdapter extends RecyclerView.Adapter<TrendBookAdapter.RecylerViewHolder> {

    private Context context;
    private ArrayList<BookTrend> books;
    private Service service = APIService.getService();

    public TrendBookAdapter(Context context, ArrayList<BookTrend> books) {
